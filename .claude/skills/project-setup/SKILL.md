...
追記後、**すでに tracked なファイルを git の追跡対象から外す**：
...
- **自動修正してよいもの**: プレースホルダ置換、.gitignore エントリ追記、tracked OS インフラファイル（.claude/ os_scripts/ os_docs/）の `git rm --cached`、.ai-context.md リセット、資材のコピー（テンプレパス判明時）、GitHub remote の切り替え
